...
EMAIL = "مثالك@gmail.com"  # بريدك الإلكتروني
PASSWORD = os.getenv("EMAIL_PASSWORD")  # احفظ كلمة سر التطبيق في متغير بيئة باسم EMAIL_PASSWORD
...
def download():
    ...
    try:
        ...
        print("\n❌ خطأ في تسجيل الدخول!\n")
        print("💡 الحل:")
        print("1. أنشئ كلمة سر لتطبيق Gmail من هنا: https://myaccount.google.com/apppasswords")
        print("2. ضع كلمة السر في متغير البيئة EMAIL_PASSWORD")
    except Exception as e:
        print(f"\n❌ خطأ عام: {e}")
